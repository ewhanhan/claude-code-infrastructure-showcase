...
["entities", blogId]["entities", blogId, "summary"] // With view mode
  ["entities", blogId, "flat"] // Single entity
  ["entity", blogId, entityId] // Related data
  ["entity", entityId, "history"]["entity", entityId, "comments"] // User-specific
  ["user", userId, "profile"]["user", userId, "permissions"];
```
